...
export async function run() {
  try {
    ...
    if (process.platform == "linux") {
      await execShellCommand("curl -sL https://github.com/owenthereal/upterm/releases/download/v0.6.7/upterm_linux_amd64.tar.gz | tar zxvf - -C /tmp upterm && install /tmp/upterm /usr/local/bin/")
